...
#A ideia é criar um filtro de colunas para que o usuário selecione quais colunas ele deseja ver no dataframe
#para isso vamos usar o expander e multiselect
...
# Ativando a filtragem do pandas usando o m´todo query
